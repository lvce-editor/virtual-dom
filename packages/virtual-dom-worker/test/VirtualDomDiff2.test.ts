...
test('diff2 - multiple attributes changed', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      className: 'old-class',
...
test('diff2 - node type changed from div to span', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      childCount: 1,
...
test('diff2 - remove all attributes', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      className: 'old-class',
...
test('diff2 - empty text to non-empty text', () => {
  const oldNodes = [text('')]
...
test('diff2 - text node to div node', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      childCount: 1,
...
test('diff2 - two node type changes', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      childCount: 2,
...
test('diff2 - two nested node type changes', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      childCount: 2,
...
test('diff2 - three node type changes', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      childCount: 3,
...
test('diff2 - same attribute values should not generate patches', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
...
test('diff2 - mixed attribute changes', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
...
test('diff2 - button to input conversion', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      childCount: 1,
...
test('diff2 - same text content should not generate patches', () => {
  const oldNodes = [text('hello')]
  const newNodes = [text('hello')]
  const patches = diff2(oldNodes, newNodes)
  expect(patches).toEqual([])
...
test('diff2 - multiple text nodes in sequence', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      childCount: 2,
...
test('diff2 - deep nested structure', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      childCount: 1,
...
test('diff2 - node with multiple children', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      childCount: 3,
...
test('diff2 - add data attributes', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      childCount: 0,
...
test('diff2 - change element with ARIA attributes', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Button,
...
test('diff2 - child removed, sibling added', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      childCount: 2,
...
test('diff2 - child added, sibling removed', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      childCount: 3,
...
test('diff2 - text node changed 1', () => {
  const oldNodes = [text('hello')]
  const newNodes = [text('world')]
  const patches = diff2(oldNodes, newNodes)
  expect(patches).toEqual([
...
test('diff2 - attribute removed 1', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      className: 'old-class',
...
test('diff2 - multiple attributes changed 1', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      className: 'old-class',
...
test('diff2 - first child and nested child removed', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      childCount: 1,
...
test('diff2 - two children removed', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      childCount: 2,
...
test('diff2 - three children removed', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      childCount: 3,
...
test('diff2 - four children removed', () => {
  const oldNodes = [
    {
      type: VirtualDomElements.Div,
      childCount: 4,
...
test('large diff2', () => {
  ...
  expect(patches).toEqual([
    ...
    // TODO this should not be in the diff2, search header details hasn't changed
    {
      type: PatchType.SetAttribute,
      key: 'className',
