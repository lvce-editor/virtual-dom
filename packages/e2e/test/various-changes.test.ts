...
test('diff - various changes', async ({ page }) => {
  ...
  expect(innerHTML).toBe(
    '<div class="Main"><div class="EditorGroup" style="width: 100%;"><div class="EditorGroupHeader" role="none"><div class="MainTabs" role="tablist"><div aria-selected="true" class="MainTab MainTabSelected" data-group-index="0" data-index="0" role="tab" title="memfs:///workspace/file1.ts"><img class="TabIcon" role="none" src="extensions/builtin.vscode-icons/icons/file_type_typescript.svg"><span class="TabTitle">file1.ts</span><button aria-label="Close" class="EditorTabCloseButton" data-group-index="0" data-index="0"><div class="MaskIcon MaskIconClose"></div></button></div></div></div><div class="EditorContainer"><button class="Editor"></button></div></div></div>',
  )
})
